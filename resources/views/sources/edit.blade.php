...
@component('common-components.breadcrumb')
    @slot('pagetitle') مدیریت منابع @endslot
    @slot('title') ویرایش منبع @endslot
@endcomponent
...
<div class="row">
    <div class="col-lg-12">
        ...
        <form method="POST" action="{{ route('sources.update', $source->id) }}" id="multiForm">
            @csrf
            @method('PUT')

            <div id="addsource-accordion" class="custom-accordion">
                ...
                <div class="card">
                    <a href="#person-collapse" class="text-dark" data-bs-toggle="collapse" aria-expanded="true" aria-controls="person-collapse">
                        <div class="p-4 d-flex align-items-center">
                            ...
                            <div class="flex-grow-1">
                                <h5 class="font-size-16 mb-1">مشخصات منبع حقیقی</h5>
                    ...
                    <div id="person-collapse" class="collapse show" data-bs-parent="#addsource-accordion">
                        <div class="p-4 border-top">
                            ...
                            <div class="row">
                                <div class="col-md-4 mb-3">
                                    ...
                                    <input type="text" name="person[first_name]"
                                           ...
                                           value="{{ old('person.first_name', $source->first_name) }}">
                                ...
                                <div class="col-md-4 mb-3">
                                    ...
                                    <input type="text" name="person[last_name]"
                                           ...
                                           value="{{ old('person.last_name', $source->last_name) }}">
                                ...
                                <div class="col-md-4 mb-3">
                                    ...
                                    <input type="date" name="person[birthdate]"
                                           ...
                                           value="{{ old('person.birthdate', $source->birthdate) }}">
                            ...
                            <div class="row">
                                <div class="col-md-4 mb-3">
                                    ...
                                    <input type="text" name="person[national_code]"
                                           ...
                                           value="{{ old('person.national_code', $source->national_code) }}">
                                ...
                                <div class="col-md-4 mb-3">
                                    ...
                                    <input type="text" name="person[passport_number]"
                                           ...
                                           value="{{ old('person.passport_number', $source->passport_number) }}">
                                ...
                                <div class="col-md-4 mb-3">
                                    ...
                                    <input type="email" name="person[email]"
                                           ...
                                           value="{{ old('person.email', $source->email) }}">
                                    @error('person.email')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                            ...
                            <div id="person-addresses">
                                @php
                                    ...
                                    if (empty($personAddresses) && $source->addresses) {
                                        $personAddresses = $source->addresses->map(function($addr) {
                                            $provinceOptions = [];
                                            $cityOptions = [];
                ...
                <div class="card">
                    <a href="#company-collapse" class="text-dark collapsed" data-bs-toggle="collapse" aria-controls="company-collapse">
                        <div class="p-4 d-flex align-items-center">
                            ...
                            <div class="flex-grow-1">
                                <h5 class="font-size-16 mb-1">مشخصات شرکت منبع</h5>
                    ...
                    <div id="company-collapse" class="collapse" data-bs-parent="#addsource-accordion">
                        <div class="p-4 border-top">
                            @php $company = $source->company ?? null; @endphp
            ...
            <div class="row mt-4 mb-0">
                <div class="col text-end">
                    ...
                    <a href="{{ route('sources.index') }}" class="btn btn-danger">
