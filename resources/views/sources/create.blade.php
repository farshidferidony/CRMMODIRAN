...
@component('common-components.breadcrumb')
    ...
    @slot('title') ایجاد منبع جدید @endslot
@endcomponent
...
<div class="row">
    <div class="col-lg-12">
        ...
        <form method="POST" action="{{ route('sources.store') }}" id="multiForm">
            @csrf
            <div id="addsource-accordion" class="custom-accordion">
                    ...
                    <div id="person-collapse" class="collapse show" data-bs-parent="#addsource-accordion">
                        <div class="p-4 border-top">
                            ...
                            <div id="person-addresses">
                                @php $personAddresses = old('person.addresses', []); @endphp
                ...
                <div class="card">
                    <a href="#company-collapse" class="text-dark collapsed" data-bs-toggle="collapse" aria-controls="company-collapse">
                        <div class="p-4 د-flex align-items-center">
                            <div class="avatar-xs me-3">
                    ...
                    <div id="company-collapse" class="collapse" data-bs-parent="#addsource-accordion">
                        <div class="p-4 border-top">
                            ...
                            <div id="company-addresses">
                                @php $companyAddresses = old('company.addresses', []); @endphp
            ...
            <div class="row mt-4 mb-0">
                <div class="col text-end">
                    <button type="submit" class="btn btn-success">
                        <i class="uil uil-file-alt me-1"></i> ذخیره
                    </button>
