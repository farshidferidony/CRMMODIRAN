...
use App\Http\Controllers\TransportAccountingController;
use App\Http\Controllers\TransportSalesController;
use App\Http\Controllers\TransportClosingController;
use App\Http\Controllers\TransportPurchaseController;
...
Route::middleware(['auth', 'route.permission'])->group(function () {
    ...
    // Resource Routes (پابلیک + auth بعداً با middleware کنترل می‌شود)
    ...
    // API Products by Category (درختی)
    ...
    // Access Matrix (فقط ceo و it_manager)
    Route::middleware('role:ceo|it_manager')->group(function () {
        ...
        // Ajax: وضعیت permissionهای یک کاربر
    ...
    // Transport Wizard زیر pre-invoices
    ...
    Route::prefix('transports/{transport}')->name('transports.')->group(function () {
        ...
        Route::put('vehicles/{vehicle}/accounting', [TransportAccountingController::class, 'updateVehicle'])->name('accounting.updateVehicle');
        Route::put('accounting/settle-all',         [TransportAccountingController::class, 'settleAll'])->name('accounting.settleAll');

        Route::put('sales-manager-approve', [TransportSalesController::class, 'approve'])->name('sales-manager.approve');
        Route::put('close',                 [TransportClosingController::class, 'close'])->name('close');
    });
